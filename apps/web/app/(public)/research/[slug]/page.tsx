  ...
  return (
    <>
      ...
      {article.faq_items.length > 0 && (
        <FAQSchema questions={article.faq_items} />
      )}
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <header className="mb-10">
            {article.category && (
              <Link
                ...
                className="mb-4 inline-flex items-center rounded-full bg-[rgba(36,144,237,0.12)] px-3 py-1 text-xs font-medium text-[#2490ed] hover:bg-[rgba(36,144,237,0.2)] transition-colors"
              >
                {article.category}
              </Link>
            )}
          ...
          <article
            className="prose prose-invert prose-lg max-w-none
              ...
              prose-a:text-[#2490ed] prose-a:no-underline hover:prose-a:underline
              prose-strong:text-white/90
              prose-code:rounded prose-code:bg-white/[0.06] prose-code:px-1.5 prose-code:py-0.5 prose-code:text-sm
              prose-blockquote:border-l-[#2490ed] prose-blockquote:text-white/50
            ...
            <section className="mt-12 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  {article.author_nrpg_id && (
                    <p className="mb-2 text-xs text-[#2490ed]">NRPG Member · {article.author_nrpg_id}</p>
                  )}
          ...
          {article.related_restore_assist.length > 0 && (
            <section className="mt-12">
              <h2 className="mb-4 text-lg font-semibold text-white">Related RestoreAssist Features</h2>
